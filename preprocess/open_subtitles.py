...
with open("/mimer/NOBACKUP/groups/naiss2024-6-297/BabyLM2025/text_data/train_10M/open_subtitles.train") as f:
    with open("../data/processed/open_subtitles.txt", 'w') as g:
        for line in preprocess(f):
            g.write(f"{line}\n")

with open("/mimer/NOBACKUP/groups/naiss2024-6-297/BabyLM2025/text_data/dev/open_subtitles.dev") as f:
    with open("../data/processed/dev/open_subtitles.txt", 'w') as g:
        for line in preprocess(f):
            g.write(f"{line}\n")
