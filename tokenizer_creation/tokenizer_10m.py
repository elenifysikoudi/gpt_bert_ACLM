...
def calculate_stats(tokenizer, args):
    ...
    all_tokens = []
    for i, document in enumerate(open(f"{args.input_path}")):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default="../data/processed/all.txt", help='Specify the input filename')
    #parser.add_argument('--validation_path', type=str, default="../data/babycosmofine_10M.jsonl", help='Specify the validation filename')
    parser.add_argument('--vocab_path', type=str, default="/mimer/NOBACKUP/groups/naiss2024-6-297/gpt-bert/tokenizers/tokenizer_10M_new.json", help='Specify the output filename')
    ...
    #ds = load_dataset("ltg/babylm-2024-baby-cosmo-fine-10m")
    #full_ds = ds["train"]
